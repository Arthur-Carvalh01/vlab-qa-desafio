...
- **Módulo de Login:** Validação de autenticação, segurança (bypass e campos mascarados), responsividade e acessibilidade.
...
```bash
git clone https://github.com/Arthur-Carvalh01/vlab-qa-desafio.git
```
...
- `Documentação/`: (Em breve) Conterá o Plano de Testes (Cenários BDD, Casos de Teste) e o Bug Report.
